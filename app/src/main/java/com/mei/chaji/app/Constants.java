...
public class Constants {
    ...
    public static final String AES_KEY = "TMOMP20190422ASE";

    /**
     * Path
     */
    public static final String PATH_DATA = ChajiAPP.getInstance().getCacheDir().getAbsolutePath() + File.separator + "data";
    ...
    public static final int DEFAULT_VALUE_SIZE = 80;
