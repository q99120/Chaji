package com.mei.chaji.ui.main.view;
...
public class WaveProgressBall extends View {
    ...
    private String mWaveColor = "#FCC79D";
    private String mWaveColorEnd = "#FC943C";
    ...
    private int mWidth;
    private int mHeight;
    private float mTexrSize = 88;
    private Path mWavepath;
    private float mWaveSpeed = 250;
    ...
    private String TAG = "waveprogress";
    ...
    private void init() {
        ...
        mColors1 = new int[]{Color.parseColor(mWaveColorEnd),Color.parseColor(mWaveColorEnd)};
        mColors2 = new int[]{Color.parseColor(mWaveColor), Color.parseColor(mWaveColor)};
        mWavepath = new Path();
        //波浪的画笔
