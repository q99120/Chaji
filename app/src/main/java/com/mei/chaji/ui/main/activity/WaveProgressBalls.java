...
public class WaveProgressBalls extends View {
    ...
    public WaveProgressBalls(Context context) {
        this(context, null);
    }

    public WaveProgressBalls(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public WaveProgressBalls(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
