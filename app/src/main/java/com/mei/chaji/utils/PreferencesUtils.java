...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "chaji_sp";
    ...
    /**
     *根据key返回SharedPreferences是否包含指定的key数据
     * @param context
     * @param key
     * @return
     */
     ...
     * 删除元素
     * */
    public static boolean romove(Context context, String key){
        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
        editor.remove(key);
        return editor.commit();
     ...
     * @return
     */
    public static boolean putString(Context context, Map<String,String> params) {
        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
