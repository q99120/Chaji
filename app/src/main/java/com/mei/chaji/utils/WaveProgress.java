...
//    private int mLightWaveColor;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mCircleColor = typedArray.getColor(R.styleable.WaveProgress_circleColor, getResources().getColor(R.color.circle_bg));
        mBgCircleColor = typedArray.getColor(R.styleable.WaveProgress_bgCircleColor,getResources().getColor(R.color.circle_go_bg));
        ...
        mDarkWaveColor = typedArray.getColor(R.styleable.WaveProgress_darkWaveColor,
                getResources().getColor(R.color.wave_color));
...
//        drawLightWave(canvas);
    ...
    private void drawCircle1(Canvas canvas) {
        canvas.save();
        canvas.rotate(370, mCenterPoint.x, mCenterPoint.y);
...
//        }
        if (mPrePercent == 0.0f || Math.abs(mPercent - mPrePercent) >= 0.000001f) {
            mPercentValue = String.format("%.0f%%", mPercent * 100);
            Log.e(TAG, "drawProgress: "+mPercent );
    ...
    private void startAnimator(final float start, float end, long animTime) {
        ...
        mProgressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                Log.e(TAG, "onAnimationUpdate: "+mValue );
//                if (BuildConfig.DEBUG) {
